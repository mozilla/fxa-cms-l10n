...
fxa-description-da2a8a91 = Βοηθήστε μας να βεβαιωθούμε ότι εσείς δημιουργείτε έναν λογαριασμό.
...
fxa-description-d28733a3 = Επιβεβαιώστε τον λογαριασμό σας και αξιοποιήστε στο έπακρο το Mozilla, όπου κι αν συνδεθείτε, ξεκινώντας με:
# Headline for Verify Short Code Email
fxa-headline-f827216f = Ανοίξτε το διαδίκτυο με τη Mozilla
...
# Description for Verify Short Code Email
fxa-description-bb7998da = Επιβεβαιώστε τον λογαριασμό σας και συγχρονίστε τους κωδικούς πρόσβασής σας οπουδήποτε έχετε συνδεθεί στο Firefox, ξεκινώντας από:
# Subject for Verify Short Code Email
...
# Headline for Email First Page
fxa-headline-b36f2b05 = Εισαγάγετε το email για να ξεκινήσει ο συγχρονισμός
# Headline for Signin Page
fxa-headline-c2b34227 = Εισαγάγετε κωδικό πρόσβασης για έναρξη συγχρονισμού
# Headline for Signup Set Password Page
...
# Description for Signup Set Password Page
fxa-description-c05d9d00 = Προστατεύει τους κωδικούς πρόσβασης, τους σελιδοδείκτες και τα συγχρονισμένα δεδομένα του Firefox με κρυπτογράφηση, όπου κι αν έχετε συνδεθεί.
# Headline for Signup Set Password Page
...
# Description for Signup Confirmed Sync Page
fxa-description-68ca3526 = Ο συγχρονισμός ενεργοποιήθηκε και είστε έτοιμοι για το Firefox VPN. Μεταβείτε στη γραμμή εργαλείων για να την ενεργοποιήσετε.
# Headline for Signup Confirmed Sync Page
...
# Description for Signup Confirm Code Page
fxa-description-daaed757 = Μόνο ένα γρήγορο βήμα. Εισαγάγετε τον κωδικό από το email σας για να ενεργοποιήσετε τον λογαριασμό Mozilla σας.
# Headline for Signup Set Password Page
...
# Description for New Device Login Email
fxa-description-4e3d5811 = Έγινε νέα σύνδεση στο Mozilla Monitor. Αν δεν είναι αυτό, παρακαλούμε αλλάξτε τον κωδικό πρόσβασής σας.
# Headline for New Device Login Email
...
# Logo Alt Text for Email First Page
fxa-logoAltText-e9e92d2e = συγχρονισμός κωδικών πρόσβασης
# Email From Name for Shared
fxa-emailFromName-763f7f1a = Firefox
# Description for Signup Set Password Page
fxa-description-32c1f240 = Δημιουργήστε έναν λογαριασμό Mozilla για ασφαλή συγχρονισμό σε άλλη συσκευή.
# Subject for Verify Short Code Email
...
# Description for Email First Page
fxa-description-6591d2a0 = Ένας λογαριασμός ξεκλειδώνει την πρόσβαση στο VPN και συγχρονίζει τα δεδομένα του Firefox σας μεταξύ των συσκευών.
# Headline for Email First Page
fxa-headline-6aca2436 = Ενεργοποιήστε το δωρεάν Firefox VPN σας με έναν λογαριασμό Mozilla
# Description for Signup Confirmed Sync Page
fxa-description-811350a6 = Ένα ακόμα βήμα για τα οφέλη του Firefox VPN. Μεταβείτε στον ανοικτό πίνακα και ενεργοποιήστε τον.
...
# Logo Alt Text for Email First Page
fxa-logoAltText-c4b14a5b = άλμα αλεπούς
